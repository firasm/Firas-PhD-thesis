...
\section{Preface}
\todo[backgroundcolor=blue!20!white]{What's the first appkication?}
...
We hypothesized that \deleted{after} treatment with a \acs{VEGF} inhibitor will result in a decrease of vessel permeability as measured with \acs{DCE-MRI} with HPG-GdF.
