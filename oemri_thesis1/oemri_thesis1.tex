...
\subsection{\texorpdfstring{\acs{ICA}}{ICA} isolates small changes in \texorpdfstring{T$_1$}{T_1}W signal intensity}
...
Two examples are shown, with a low and high degree of variability measured in the extracted components~\todo[backgroundcolor=red!20!white]{SAR: very unsatisfying not the be told why there is a high and low variability version here. How come, what's the difference, what does it mean?}.
