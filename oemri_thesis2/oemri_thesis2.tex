...
\begin{figure}[htbp]
   ...
   \caption{The proportion of negative \ac{dOE-MRI} voxels is plotted against the histological hypoxic fractions with Pearson's r = 0.91 for SCCVII tumours and r = 0.13 for HCT-116 tumours. Each point is a multi-slice tumour average. Correlations done with multiple slices
