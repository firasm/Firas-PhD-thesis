...
\subsection{Vascular area \texorpdfstring{$A$}{A} and mean velocity \texorpdfstring{$v_f$}{vf} do not vary across tumour models, but \texorpdfstring{$\sigma_f$}{sigma_f} differentiates between tumours}
