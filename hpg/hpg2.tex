...
\label{ch:HPG2}
\SARi{Figure out whether you are using heading-style or sentence-style capitalization ocnventions in your headings at the various levels. You should then be consistent within a level}
...
The sections reproduced here in this chapter were part of a larger study exploring the distribution of \replaced[comment={check throughout}]{trastuzumab}{Trastuzumab}, including exploring the microenvironments of \acs{HER2}-positive tumours and metastases including immunohistochemistry maps, 3D tissue models and dynamic imaging of tumour vasculature.
This work was led by Dr.\ Jennifer Baker and the Andrew Minchinton lab in collaboration with the Reinsberg lab and published, with me as the fourth author in \deleted{the manuscript.
This study was published in} the peer-reviewed journal \emph{Clinical \& Experimental Metastasis} \deleted{with the manuscript} titled ``Heterogeneous distribution of Trastuzumab in \acs{HER2}-positive xenografts and metastases: role of the tumor microenvironment''.
...
\todo[backgroundcolor=blue!20!white]{comma after survival?}
...
\todo[backgroundcolor=blue!20!white]{more black blocks}
...
\todo[backgroundcolor=blue!20!white]{figure caption on top of the page number again}
\begin{figure}[htbp] % figure placement: here, top, bottom, or page
  \centering
...
\todo[backgroundcolor=blue!20!white]{in humans, MAbs}
...
\todo[backgroundcolor=blue!20!white]{in vivo should be italacized so as to not be confused with saying in}
However, our 3D tissue disc data shows Trastuzumab is able to diffuse relatively well through tumour tissues \emph{in vivo} in conditions of poor convective flow similar to an environment with high interstitial fluid pressure in vivo~\cite{Baker:2018ex}.~\todo[backgroundcolor=red!20!white]{not actually shown here, need to ref the paper}
...
\section{Conclusions}
\todo[backgroundcolor=blue!20!white]{access of the MAb, Trastuzumab, in pre}
...
\SARi{as stated above. Make sure it's not patently ovious that you copy-and-pasted a paper. It has to conform to the conventions in the rest of your thesis. Beyond the editing business, this is in good working order, not surprisingly.}
