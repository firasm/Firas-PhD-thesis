...
\todo[backgroundcolor=blue!20!white]{In addition to ITS utility}
...
\todo[backgroundcolor=blue!20!white]{should be an 'and' not an comma right?}
...
\todo[backgroundcolor=blue!20!white]{I don't know what you mean by "such that"} 
...
\todo[backgroundcolor=blue!20!white]{You used a dash here for hyperpermeable, do the same in the 3rd previous sentence}
...
\todo[backgroundcolor=blue!20!white]{Should the 111 be superscripted? Also this seems like a random aside, so what if it was? why do we care}
...
\todo[backgroundcolor=blue!20!white]{space between 5 and min}
...
\begin{figure}[htbp]
 ...
 \end{center}
\end{figure}
\todo[backgroundcolor=blue!20!white]{Figure caption is clashing with the page number}
...
\todo[backgroundcolor=blue!20!white]{60mins needs a space} 
...
\todo[backgroundcolor=blue!20!white]{ Sentence could be clearer}
...
\todo[backgroundcolor=blue!20!white]{without this information, ....}
...
\todo[backgroundcolor=blue!20!white]{here, the amount/ weird commas around the and}
