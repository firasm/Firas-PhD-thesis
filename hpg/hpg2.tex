...
\begin{figure}[htbp] % figure placement: here, top, bottom, or page
  ...
  The \acs{AUC}$_{60}$ map is compared with slice-matched histology sections of bound trastuzumab (purple), vascular architectural markers $\alpha$SMA and CIV (both shown in red).}
