...
\noindent\textbf{OE-MRI with Fourier Filtering:} \todo{Methods for Fourier Transform}
...
\subsection{Comparing ICA with the Fourier Transform}

\todo{Results for Fourier Transform}
