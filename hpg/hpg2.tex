...
\todo[backgroundcolor=blue!20!white]{cytoxins not cytoxics?}
...
\todo[backgroundcolor=blue!20!white]{relatively is wrong should be -> far from vessels in tumours relative to even HER2 distribution}
...
\todo[backgroundcolor=blue!20!white]{The heterogeneity of HER2 to Trastuzumab?}
...
\todo[backgroundcolor=blue!20!white]{What are these black blocks?}
...
\todo[backgroundcolor=blue!20!white]{This figure caption has a big vertical black bar}
...
However, our 3D tissue disc data shows Trastuzumab is able to diffuse relatively well through tumour tissues in vivo in conditions of poor convective flow similar to an environment with high interstitial fluid pressure in vivo~\cite{Baker:2018ex}.~\todo[backgroundcolor=red!20!white]{not actually shown here, need to ref the paper}
...
\todo[backgroundcolor=blue!20!white]{too many ands}
