...
\begin{figure}[htbp] % figure placement: here, top, bottom, or page
  ...
  B) \acs{AUC}$_{60}$ maps using Gadovist in \acs{MDA-MB-361} tumours is compared with slice-matched histology sections of bound trastuzumab (purple), vascular architectural markers $\alpha$SMA and CIV (both shown in red).}
