...
\chapter{Interlude}
\label{ch:interlude}
\SARi{I don't understand why this can't be put as part of the introduction in the next chapter. An interlude is awkward...}
...
\subsection{Theory}
\SARi{I mean, even sticking this in the Introduction chapter is an option.}
...
The binding affinity for O$_2$ drastically increases for subsequent oxygen molecules that bind to \acs{Hb} as the conformation of the \acs{Hb} molecule changes to increase binding affinity for the next oxygen, a phenomenon called cooperativity. 
...
Upon inspiration of atmospheric air (p$_{O_2}$ = 160 mmHg), gas exchange in the pulmonary capillary beds occurs in the alveoli of the lungs~\ref{mmhg}.
...
Simultaneously, the \acs{Hb} molecule undergoes a structural change releasing a molecule of O$_2$ from its first binding site.  
