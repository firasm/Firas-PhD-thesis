...
\begin{figure}[htbp]
 ...
 \caption{\acs{HPG-GdF}. The 583  \acs{kDa} globular Hyperbranched PolyGlycerol (HPG) molecules are derivatized with p-NH$_2$-benzyl-DOTA (Macrocyclics) at 20 $\mu$g Gd per mg HPG (approximately 300 chelates per molecule) and tagged with Alexa Fluor 647 dye, as previously described~\cite{Saatchi:2012hc}. Figure reused with permission from Wiley and Sons.}
...
\begin{figure}[htbp]
 ...
 (C) The fraction of MR-measured \acs{HPG-GdF} \acs{BAT}-enhancing voxels has a negative association with the proportion of necrotic tissue determined in histological sections. Figure reused with permission from Wiley and Sons.}
...
A former lab member developed a set of criteria based on control theory as part of their masters thesis~\cite{Baker:2015cob}.
...
\subsubsection{Pharmacokinetic modelling of DCE-MRI data}
...
\begin{figure}[htbp]
 ...
 \caption{Individual HT29 tumour (T01-05) slice maps are presented for parameters derived using Gadovist (\acs{BAT}, \acs{AUGC$_{60}$}, \acs{K$^{trans}$}), \acs{HPG-GdF} (\acs{BAT}, \acs{fPV}, \acs{aPS}, \acs{AUGC$_{60}$}) and histological imaging of necrosis. Figure reused with permission from Wiley and Sons.}
...
\begin{figure}[htbp]
 ...
 A region with high \acs{aPS} that does not correspond to high \acs{fPV} is magnified (A) and compared with a high \acs{fPV} region that does not correspond to high \acs{aPS} (B). Figure reused with permission from Wiley and Sons.}
...
\end{tabular}
\caption{Summary of MRI parameters derived from pharmacokinetic modelling of the Gadovist contrast agent for both the HCT116 and HT29 tumours.}
...
\begin{figure}[htbp]
 ...
 A greater degree of \acs{HPG-GdF} accumulation can easily be appreciated in the HT29 tumours. Figure reused with permission from Wiley and Sons.}
