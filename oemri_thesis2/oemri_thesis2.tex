...
\begin{figure}[htbp]
   \includegraphics[width=\textwidth]{oemri_thesis1/oemri_thesis2-images/histocorrel3.pdf} % requires the graphicx package % note for Firas: I changed the aspect ratio of this figure slightly
...
Using the \ac{dOE-MRI} technique, we found that an oxygen-enhancing component was extracted successfully in all imaged animals across a range of tumour models and environments (Figure~\ref{versatile}).
...
Though the \ac{dOE-MRI} technique presented here did not successfully correlate with histological hypoxic fractions, there is promise in the technique to map oxygenation in tumours in the absence of necrosis (Fig.~\ref{histo_correlations}). 
...
% tumour oxygenation \ac{dOE-MRI} and histology measures in SCCVII tumours but, despite improvements to sensitivity, 
