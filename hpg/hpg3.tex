...
bevacizumab - marketed clinically under `Avastin$^{\tiny{\mathrm{\textcopyright}}}$' - is a monoclonal antibody that binds VEGF extracellularly, preventing the interaction of of \acs{VEGF} to its receptors and inhibits angiogenesis. 
