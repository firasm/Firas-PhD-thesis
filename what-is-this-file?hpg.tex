...
Averaged data from whole HT29 tumour xenograft images obtained using MRI and histology showed accumulation of HPG-GdF over time (Fig.~\ref{hpgpaper:fig3}(A)), as previously described~\cite{Saatchi:2012hc}.
