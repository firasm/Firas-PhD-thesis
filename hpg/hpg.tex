...
Signal enhancement is linked to contrast agent concentration within the tumour blood vessels at early time points after injection for intravascular \acs{MCA}s so plasma volumes (\acs{v$_p$}) in the tumour can be determined.
